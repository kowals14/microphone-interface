...
#define AUDIOFX_FILTER0			(AUDIOFX_Type) 0
#define AUDIOFX_FILTER1			(AUDIOFX_Type) 1
#define AUDIOFX_FILTER2			(AUDIOFX_Type) 2
#define AUDIOFX_FILTER3			(AUDIOFX_Type) 3
#define AUDIOFX_FILTER4			(AUDIOFX_Type) 4
